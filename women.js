...
let fetchs = async ()=>{
    try {
         res = await fetch(`http://35.88.207.97:4000/womens`)
         data = await res.json()
        data=data.women
        console.log(data)
        appenddata()
 ...
 function appenddata(){
    ...
    img1.setAttribute("id","appended_bargains_img")
    img1.src = data[0].img
    let img2 = document.createElement("img")
    img2.setAttribute("id","appended_bargains_img")
    img2.src = data[1].img
    let img3 = document.createElement("img")
    img3.setAttribute("id","appended_bargains_img")
    img3.src = data[2].img
    let img4 = document.createElement("img")
   img4.setAttribute("id","appended_bargains_img")
   img4.src = data[3].img
    let img5 = document.createElement("img")
    img5.setAttribute("id","appended_bargains_img")
    img5.src = data[4].img
    let img6 = document.createElement("img")
    img6.setAttribute("id","appended_bargains_img")
    img6.src = data[5].img
 ...
 //    p.textContent = ele.name
    ...
    document.getElementById("append_bargains_img").append(img1,img2,img3,img4,img5,img6)

 let img7 = document.createElement("img")   
 img7.setAttribute("id","top_brand_img")
 img7.src = data[6].img
 let img8 = document.createElement("img")   
 img8.setAttribute("id","top_brand_img")
 img8.src = data[7].img
 let img9 = document.createElement("img")   
 img9.setAttribute("id","top_brand_img")
 img9.src = data[8].img
 let img10 = document.createElement("img")   
 img10.setAttribute("id","top_brand_img")
 img10.src = data[9].img
 let img11 = document.createElement("img")   
 img11.setAttribute("id","top_brand_img")
 img11.src = data[10].img
 let img12 = document.createElement("img")   
 img12.setAttribute("id","top_brand_img")
 img12.src = data[11].img


 document.getElementById("append_top_brand_img").append(img7,img8,img9,img10,img11,img12)

let img13 =document.createElement("img")
img13.setAttribute("id","shoppers_img")
img13.src = data[12].img
let img14 =document.createElement("img")
img14.setAttribute("id","shoppers_img")
img14.src = data[13].img
let img15 =document.createElement("img")
img15.setAttribute("id","shoppers_img")
img15.src = data[14].img
let img16 =document.createElement("img")
img16.setAttribute("id","shoppers_img")
img16.src = data[15].img
let img17 =document.createElement("img")
img17.setAttribute("id","shoppers_img")
img17.src = data[16].img
let img18 =document.createElement("img")
img18.setAttribute("id","shoppers_img")
img18.src = data[17].img


document.getElementById("append_shoppers_img").append(img13,img14,img15,img16,img17,img18)


let img19 = document.createElement("img")
img19.setAttribute("id","appended_winter_img")
img19.src = data[18].img

let img20 = document.createElement("img")
img20.setAttribute("id","appended_winter_img")
img20.src = data[19].img

let img21 = document.createElement("img")
img21.setAttribute("id","appended_winter_img")
img21.src = data[20].img

let img22 = document.createElement("img")
img22.setAttribute("id","appended_winter_img")
img22.src = data[21].img


document.getElementById("append_winter_img").append(img19,img20,img21,img22)



let img23 = document.createElement("img")
img23.setAttribute("id","appended_love_img")
img23.src = data[22].img

let img24 = document.createElement("img")
img24.setAttribute("id","appended_love_img")
img24.src = data[23].img

let img25 = document.createElement("img")
img25.setAttribute("id","appended_love_img")
img25.src = data[24].img

let img26 = document.createElement("img")
img26.setAttribute("id","appended_love_img")
img26.src = data[25].img

document.getElementById("append_love_img").append(img23,img24,img25,img26)



let img27 = document.createElement("img")
img27.setAttribute("id","appended_love_img")
img27.src = data[26].img
let img28 = document.createElement("img")
img28.setAttribute("id","appended_love_img")
img28.src = data[27].img
let img29 = document.createElement("img")
img29.setAttribute("id","appended_love_img")
img29.src = data[28].img
let img30 = document.createElement("img")
img30.setAttribute("id","appended_love_img")
img30.src = data[29].img


document.getElementById("append_budget_img").append(img27,img28,img29,img30)


let img31 = document.createElement("img")
img31.setAttribute("id","appended_bargains_img")
img31.src = data[30].img
let img32 = document.createElement("img")
img32.setAttribute("id","appended_bargains_img")
img32.src = data[31].img
let img33 = document.createElement("img")
img33.setAttribute("id","appended_bargains_img")
img33.src = data[32].img
let img34 = document.createElement("img")
img34.setAttribute("id","appended_bargains_img")
img34.src = data[33].img
let img35 = document.createElement("img")
img35.setAttribute("id","appended_bargains_img")
img35.src = data[34].img
let img36 = document.createElement("img")
img36.setAttribute("id","appended_bargains_img")
img36.src = data[35].img


document.getElementById("append_trend_img").append(img31,img32,img33,img34,img35,img36)


let img37 = document.createElement("img")
img37.setAttribute("id","appended_bargains_img")
img37.src = data[36].img
let img38 = document.createElement("img")
img38.setAttribute("id","appended_bargains_img")
img38.src = data[37].img
let img39 = document.createElement("img")
img39.setAttribute("id","appended_bargains_img")
img39.src = data[38].img
let img40 = document.createElement("img")
img40.setAttribute("id","appended_bargains_img")
img40.src = data[39].img
let img41 = document.createElement("img")
img41.setAttribute("id","appended_bargains_img")
img41.src = data[40].img
let img42 = document.createElement("img")
img42.setAttribute("id","appended_bargains_img")
img42.src = data[41].img


document.getElementById("bot-sweat").append(img37,img38,img39,img40,img41,img42)


let img43 = document.createElement("img")
img43.setAttribute("id","top_brand_img")
img43.src = data[42].img
let img44 = document.createElement("img")
img44.setAttribute("id","top_brand_img")
img44.src = data[43].img
let img45 = document.createElement("img")
img45.setAttribute("id","top_brand_img")
img45.src = data[44].img
let img46 = document.createElement("img")
img46.setAttribute("id","top_brand_img")
img46.src = data[45].img
let img47 = document.createElement("img")
img47.setAttribute("id","top_brand_img")
img47.src = data[46].img
let img48 = document.createElement("img")
img48.setAttribute("id","top_brand_img")
img48.src = data[47].img


document.getElementById("append_best_brand_img").append(img43,img44,img45,img46,img47,img48)


let img49 = document.createElement("img")
img49.setAttribute("id","exp_images")
img49.src= data[48].img
let img50 = document.createElement("img")
img50.setAttribute("id","exp_images")
img50.src= data[49].img
let img51 = document.createElement("img")
img51.setAttribute("id","exp_images")
img51.src= data[50].img
let img52 = document.createElement("img")
img52.setAttribute("id","exp_images")
img52.src= data[51].img
let img53 = document.createElement("img")
img53.setAttribute("id","exp_images")
img53.src= data[52].img
let img54 = document.createElement("img")
img54.setAttribute("id","exp_images")
img54.src= data[53].img
let img55 = document.createElement("img")
img55.setAttribute("id","exp_images")
img55.src= data[54].img
let img56 = document.createElement("img")
img56.setAttribute("id","exp_images")
img56.src= data[55].img
let img57 = document.createElement("img")
img57.setAttribute("id","exp_images")
img57.src= data[56].img
let img58 = document.createElement("img")
img58.setAttribute("id","exp_images")
img58.src= data[57].img
let img59 = document.createElement("img")
img59.setAttribute("id","exp_images")
img59.src= data[58].img
let img60 = document.createElement("img")
img60.setAttribute("id","exp_images")
img60.src= data[59].img


document.getElementById("append_exp").append(img49,img50,img51,img52,img53,img54,img55,img56,img57,img58,img59,img60)


let img61 = document.createElement("img")
img61.src = data[60].img

let img62 = document.createElement("img")
img62.src = data[61].img

let img63 = document.createElement("img")
img63.src = data[62].img

let img64 = document.createElement("img")
img64.src = data[63].img

let img65 = document.createElement("img")
img65.src = data[64].img

let img66 = document.createElement("img")
img66.src = data[65].img

document.getElementById("small").append(img61,img62,img63,img64,img65)
